...
class TestLab4(unittest.TestCase):
    ...
    def test_simple_02(self):
        x_list = OrderedList()
        x_list.add(10)
        # print("x_list:", x_list.python_list())
        ...
        x_list.add(50)
        x_list.add(1);
        self.assertEqual(x_list.python_list(), [1, 5, 10, 30, 50])
    ...
    def test_simple_08(self):
        ...
        c_list.add(9)
        c_list.add(12)
        self.assertEqual(c_list.python_list(), [3, 6, 9, 12])
        self.assertEqual(c_list.pop(0), 3)
        self.assertEqual(c_list.python_list(), [6, 9, 12])
        c_list.pop(1)
        self.assertEqual(c_list.python_list(), [6, 12])
        c_list.add(1)
        c_list.add(4)
        self.assertEqual(c_list.python_list(), [1, 4, 6, 12])
        c_list.pop(2)
        try:
            c_list.pop(3)
        except IndexError:
